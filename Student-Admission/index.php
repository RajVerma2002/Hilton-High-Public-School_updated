<?php
$cn = mysqli_connect("localhost", "u958447413_hilton_high", "Qwertyuiop1234567$", "u958447413_schoolDb");
                ...
                <div class="col-md-4">
                    <div class="logo">
                        <a href="">
                            ...
                            <span>Hilton High Public<span id="na">School</span></span>
                        </a>
                    </div>
                </div>
    <!--================== Main menu-area ====================-->
                ...
                <div class="col-md-1 text-right">
                    <span class="social-icon">
                        <a href="https://www.facebook.com/hiltonhighpublicschool"><i class="fa fa-facebook"></i></a>
    ...
    <footer>
        <div class="container">
            <div class="row">
                ...
                <p class="copy-right">Copyright &copy;</p>
            </div>
        </div>
    </footer>
